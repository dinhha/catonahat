...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		Thumbnails.MaxWidth = 224;
		Thumbnails.MaxHeight = 157;
		...
		// feature.
        Images.MaxWidth = 1600;// default is 1600
        Images.MaxHeight = 1200;// defaut is 1200
		Images.Quality = 80;
		...
		type.MaxSize = 0;// default maxsize =0 is not use setup above
